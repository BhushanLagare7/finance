...
function SheetTitle({
  ...
  return (
    <SheetPrimitive.Title
      className={cn(
        "text-base font-medium font-heading text-foreground",
        className,
      )}
